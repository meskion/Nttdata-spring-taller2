...
public class NttdataPeninsularOrdersServiceImpl extends NttdataOrdersManagementServiceAbstract {
	...
	public void addOrder(NttdataOrder order, NttdataProduct... products) {
		...
		prodList.forEach(p -> p.setPvpPrice(p.getTaxFreePrice() * (1 + 0.21)));
